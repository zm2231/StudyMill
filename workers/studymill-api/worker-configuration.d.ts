/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 28856df7b11e87a8f2484b141cb1d12c)
// Runtime types generated with workerd@1.20250813.0 2025-08-16 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AI_GATEWAY_OPENAI_BASE_URL: "https://gateway.ai.cloudflare.com/v1/212dd811a7eecb00d4e98febf085486e/studymill-prod/openai";
		AI_GATEWAY_GOOGLE_BASE_URL: "https://gateway.ai.cloudflare.com/v1/212dd811a7eecb00d4e98febf085486e/studymill-prod/gemini";
		AI_GATEWAY_OPENROUTER_BASE_URL: "https://gateway.ai.cloudflare.com/v1/212dd811a7eecb00d4e98febf085486e/studymill-prod/openrouter";
		ENVIRONMENT: "development" | "staging" | "production";
		API_VERSION: "v1.0.0-dev" | "v1.0.0-staging" | "v1.0.0";
		FRONTEND_URL: "http://localhost:3000" | "https://staging.studymill.ai" | "https://studymill.ai";
		USE_HYBRID_PROCESSING: "true";
		PARSE_EXTRACT_API_KEY: string;
		JWT_SECRET: string;
		GEMINI_API_KEY: string;
		CHAT_DO: DurableObjectNamespace /* ChatDurableObject from studymill-api */;
		BUCKET: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_OPENAI_BASE_URL" | "AI_GATEWAY_GOOGLE_BASE_URL" | "AI_GATEWAY_OPENROUTER_BASE_URL" | "ENVIRONMENT" | "API_VERSION" | "FRONTEND_URL" | "USE_HYBRID_PROCESSING" | "PARSE_EXTRACT_API_KEY" | "JWT_SECRET" | "GEMINI_API_KEY">> {}
}
