...
-- Extend courses with common catalog metadata (idempotent pattern)
ALTER TABLE courses ADD COLUMN code TEXT;            -- e.g., CSCI 1301
ALTER TABLE courses ADD COLUMN crn TEXT;             -- 5-digit CRN
ALTER TABLE courses ADD COLUMN semester_id TEXT;     -- link to semesters table
ALTER TABLE courses ADD COLUMN instructor TEXT;      -- display instructor
ALTER TABLE courses ADD COLUMN credits REAL;         -- numeric credits
ALTER TABLE courses ADD COLUMN location TEXT;        -- default location string
ALTER TABLE courses ADD COLUMN schedule_json TEXT;   -- optional serialized meeting info
